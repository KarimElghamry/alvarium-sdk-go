...
import (
	...
	httpAnnotators "github.com/KarimElghamry/alvarium-sdk-go/internal/annotators/http"
	handler "github.com/KarimElghamry/alvarium-sdk-go/internal/annotators/http/handler"
	"github.com/KarimElghamry/alvarium-sdk-go/internal/iota"
	"github.com/KarimElghamry/alvarium-sdk-go/internal/mock"
	"github.com/KarimElghamry/alvarium-sdk-go/internal/mqtt"
...
func NewAnnotator(kind contracts.AnnotationType, cfg config.SdkInfo) (interfaces.Annotator, error) {
	...
	case contracts.AnnotationAttestation:
		a = annotators.NewAttestationAnnotator(cfg)
	default:
